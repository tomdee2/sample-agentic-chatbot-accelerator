...
from .constants import (
    ...
    DEFAULT_REPETITIVE_HANDOFF_DETECTION_WINDOW,
    DEFAULT_REPETITIVE_HANDOFF_MIN_UNIQUE_AGENTS,
)
...
class BedrockRerankingConfiguration(BaseModel):
    ...
    Attributes:
        ...
        numberOfRerankedResults (Optional[int]): Number of results to rerank. If not specified, all retrieved results will be reranked.
