...
variable "swarm_ecr_image_uri" {
  description = "Full ECR image URI for the swarm agent runtime container. If not provided, a new ECR repository will be created."
  type        = string
  default     = null
}

variable "graph_ecr_image_uri" {
  description = "Full ECR image URI for the graph agent runtime container. If not provided, a new ECR repository will be created."
  type        = string
  default     = null
}
